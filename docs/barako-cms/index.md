...
[![License](https://img.shields.io/github/license/BaryoDev/barakoCMS)](https://github.com/BaryoDev/barakoCMS/blob/master/LICENSE)
...
See [Plugin Development Guide](./plugin-development-guide) and [Migration Guide](./workflow-migration-guide) to get started.
...
### Documentation
- **[DEVELOPMENT_STANDARDS.md](https://github.com/BaryoDev/barakoCMS/blob/master/DEVELOPMENT_STANDARDS.md)** - Field types, naming conventions, validation
- **[CHANGELOG.md](https://github.com/BaryoDev/barakoCMS/blob/master/CHANGELOG.md)** - Version history
- **[CONTRIBUTING.md](https://github.com/BaryoDev/barakoCMS/blob/master/CONTRIBUTING.md)** - Contribution guidelines
- **[CODE_OF_CONDUCT.md](https://github.com/BaryoDev/barakoCMS/blob/master/CODE_OF_CONDUCT.md)** - Community standards

### For AI Agents
- **[llms.txt](llms.txt)** - Codebase context for LLMs
- **[.cursorrules](https://github.com/BaryoDev/barakoCMS/blob/master/.cursorrules)** - Coding standards for AI assistants
- **[CITATIONS.cff](https://github.com/BaryoDev/barakoCMS/blob/master/CITATIONS.cff)** - Citation metadata
...
See [CLA.md](https://github.com/BaryoDev/barakoCMS/blob/master/CLA.md) for full agreement text.
...
See [CONTRIBUTING.md](https://github.com/BaryoDev/barakoCMS/blob/master/CONTRIBUTING.md) for detailed guidelines.
...
See [LICENSE](https://github.com/BaryoDev/barakoCMS/blob/master/LICENSE) for full terms.
